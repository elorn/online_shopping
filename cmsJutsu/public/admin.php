            ...
            <div class="modal-body">
                <form id="create-page" action="create_page.php" method="post" class="action">
                  <div class="form-group">
                    <label for="pageName">Name of Department</label>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="create_category.php" method="post" class="action">
                <div class="form-group">
                  <label for="nameCat">Company Name</label>
                ...
                <div class="form-group">
                  ...
                  <small class="form-text text-muted">Order the Departments as you like!</small>
                </div>
                <div class="modal-footer">
                  <button class="btn btn-secondary" data-dismiss="modal">Close</button>
